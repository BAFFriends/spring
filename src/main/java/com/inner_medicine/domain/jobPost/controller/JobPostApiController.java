...
public class JobPostApiController {
    ...
    @Operation(summary = "회사의 공고 생성 API")
    ...
    @Operation(summary = "공고 D-Day 오름차순 전체 조회 API")
    @GetMapping()
    ...
    @Operation(summary = "공고 id값 단일 조회 API")
    ...
    @Operation(summary = "공고 LIKE 검색어 조회 API")
    @GetMapping("/search")
